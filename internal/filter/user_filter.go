...
type UserFilter struct {
	Id        string `yaml:"id" mapstructure:"id" json:"id" gorm:"column:id;primary_key" bson:"_id" dynamodbav:"id" firestore:"id" operator:"=" validate:"required,max=40"`
	...
	Phone     string `yaml:"phone" mapstructure:"phone" json:"phone" gorm:"column:phone" bson:"phone" dynamodbav:"phone" firestore:"phone" operator:"like" validate:"required,phone,max=18"`
